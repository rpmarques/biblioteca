...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['issue'])) {
        ...
        if ($aqty > 0) {
            ...
            if ($lastInsertId) {
                $_SESSION['msg'] = "Aluguél de livro realizado";
            ...
            $_SESSION['error'] = "Livro não disponível";
            header('location:manage-issued-books.php');
        }
    }
?>
        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Novo Aluguél</h4>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <form role="form" method="post">
                                    ...
                                    <button type="submit" name="issue" id="submit" class="btn btn-info">Alugar </button>
                                </form>
                            </div>
                        </div>
                    </div>
