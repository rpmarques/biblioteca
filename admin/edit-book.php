        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Edição </h4>
                    </div>
                </div>
                <div class="row">
                                        ...
                                        foreach ($results as $result) {               ?>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid); ?>">Trocar imagem</a>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Qtde<span style="color:red;">*</span></label>
