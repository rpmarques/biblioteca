...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        if (!in_array($extension, $allowed_extensions)) {
            ...
            if ($lastInsertId) {
                echo "<script>alert('Livro cadastrador com sucesso');</script>";
                echo "<script>window.location.href='manage-books.php'</script>";
            } else {
                echo "<script>alert('Alguma coisa deu errada, tente novamente');</script>";
                echo "<script>window.location.href='manage-books.php'</script>";
            }
        }
    }
                                ...
                                <form role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">ISBN é a sigla para International Standard Book Number, ou seja, Padrão Internacional de Numeração de Livro. É um número único que identifica uma publicação, como um livro, artigo ou apostila. </p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Foto da Capa <span style="color:red;">*</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <button type="submit" name="add" id="add" class="btn btn-info">Gravar </button>
                                    </div>
                            </div>
                        </div>
                    </div>
