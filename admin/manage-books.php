...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_GET['del'])) {
        ...
        $query->execute();
        $_SESSION['delmsg'] = "Registro excluido ";
        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Manutenção de Livros</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                                                    ...
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center">
                                                            ...
                                                            <a href="edit-book.php?bookid=<?php echo htmlentities($result->bookid); ?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Editar</button>
                                                                <a href="manage-books.php?del=<?php echo htmlentities($result->bookid); ?>" onclick="return confirm('Tem certeza que deseja excluir o registro?');"" >  <button class=" btn btn-danger"><i class="fa fa-pencil"></i> Excluir</button>
                                                        </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
                                                }
