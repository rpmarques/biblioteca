      ...
      <tr>
        <?php foreach ($results as $result) { ?>
          <th style="padding-left:5%; width: 10%;">
            ...
            Nome :<?php echo htmlentities($result->BookName); ?><br />
            Autor :<?php echo htmlentities($result->AuthorName); ?><br />
            Qtde Total: <?php echo htmlentities($bqty = $result->bookQty); ?><br />
            Qtde disponível: <?php echo htmlentities($aqty = $result->bookQty - ($result->issuedBooks - $result->returnedbook)); ?><br />
            <?php if ($aqty == '0'): ?>
              <p style="color:red;">Todas unidades alugadas.</p>
            <?php else: ?>
