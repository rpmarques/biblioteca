...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $query->execute();
        $_SESSION['updatemsg'] = "Categoria Atualizada com sucesso";
    ...
    <div class=" content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Edição de Categoria</h4>
                                    ...
                                    ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php } else { ?>
                                                    <div class="radio">
                                                        <label>
                                                            <input type="radio" name="status" id="status" value="0" checked="checked">Desativado
                                                        </label>
                                                    </div>
                                                    <div class="radio">
                                                        <label>
