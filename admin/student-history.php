        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <?php $sid = $_GET['stdid']; ?>
                        <h4 class="header-line">#<?php echo $sid; ?> Histórico de Aluguéis</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                 Histórico do Aluno ID: <?php echo $sid; ?>
                            </div>
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {               ?>
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td class="center"><?php if ($result->ReturnDate == ''): echo "Não retornado";
