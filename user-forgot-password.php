...
if (isset($_POST['change'])) {
  ...
  if ($query->rowCount() > 0) {
    ...
    echo "<script>alert('Email ou Telefone errado, verifique');</script>";
  }
}
?>
<!DOCTYPE html>
  ...
  <div class="content-wrapper">
    <div class="container">
      <div class="row pad-botm">
        <div class="col-md-12">
          <h4 class="header-line">Recuperar Senha</h4>
        </div>
      </div>
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              <form role="form" name="chngpwd" method="post" onSubmit="return valid();">
                ...
                <button type="submit" name="change" class="btn btn-info">Trocar a senha</button> | <a href="index.php">Login</a>
              </form>
            </div>
          </div>
        </div>
